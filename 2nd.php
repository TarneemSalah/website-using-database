...
$connect = new PDO("mysql:host=localhost; dbname=structure", "root", "");
...
$query = "
SELECT course.course_name,course.course_discription, department.department_name, professor.professor_name
FROM ((course
...
if($_POST['query'] != '')
{
  $query .= "WHERE REPLACE(course_name,' ','') LIKE REPLACE('"."%".$_POST['query']."%"."',' ','') 
              ||  REPLACE(course_discription,' ','') LIKE REPLACE('"."%".$_POST['query']."%"."',' ','') 
